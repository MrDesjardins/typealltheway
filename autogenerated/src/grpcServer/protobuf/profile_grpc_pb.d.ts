...
interface IProfileServiceService_IGetProfile
    extends grpc.MethodDefinition<
        src_grpcServer_protobuf_profile_pb.ProfileRequest,
        src_grpcServer_protobuf_profile_pb.ProfileResponse
    > {
...
interface IProfileServiceService_IGetProfiles
    extends grpc.MethodDefinition<
        src_grpcServer_protobuf_profile_pb.ProfilesRequest,
        src_grpcServer_protobuf_profile_pb.ProfilesResponse
    > {
...
interface IProfileServiceService_IListProfiles
    extends grpc.MethodDefinition<
        src_grpcServer_protobuf_profile_pb.ListProfilesRequest,
        src_grpcServer_protobuf_profile_pb.ProfilesRequest
    > {
...
export interface IProfileServiceServer {
    getProfile: grpc.handleUnaryCall<
        ...
        src_grpcServer_protobuf_profile_pb.ProfileResponse
    >;
    getProfiles: grpc.handleUnaryCall<
        src_grpcServer_protobuf_profile_pb.ProfilesRequest,
        src_grpcServer_protobuf_profile_pb.ProfilesResponse
    >;
    listProfiles: grpc.handleUnaryCall<
        src_grpcServer_protobuf_profile_pb.ListProfilesRequest,
        src_grpcServer_protobuf_profile_pb.ProfilesRequest
    >;
}
...
export interface IProfileServiceClient {
    getProfile(
        request: src_grpcServer_protobuf_profile_pb.ProfileRequest,
        callback: (
            error: grpc.ServiceError | null,
            response: src_grpcServer_protobuf_profile_pb.ProfileResponse
        ) => void
    ...
    getProfiles(
        request: src_grpcServer_protobuf_profile_pb.ProfilesRequest,
        callback: (
            error: grpc.ServiceError | null,
            response: src_grpcServer_protobuf_profile_pb.ProfilesResponse
        ) => void
    ): grpc.ClientUnaryCall;
    getProfiles(
        request: src_grpcServer_protobuf_profile_pb.ProfilesRequest,
    ...
    listProfiles(
        request: src_grpcServer_protobuf_profile_pb.ListProfilesRequest,
        callback: (
            error: grpc.ServiceError | null,
            response: src_grpcServer_protobuf_profile_pb.ProfilesRequest
        ) => void
    ): grpc.ClientUnaryCall;
    listProfiles(
        request: src_grpcServer_protobuf_profile_pb.ListProfilesRequest,
