...
export const profileResolversMap: {
  ...
  Query: {
    getByFriendsQuantity: async (source: Partial<Profile>, args: { qte: number }, context: any, info: GraphQLResolveInfo): Promise<Profile[]> => {
  ...
  Profile: {
    name: async (profile: Partial<Profile>, args: {}, context: any): Promise<string | undefined> => {
